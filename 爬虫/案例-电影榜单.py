...
def get_movie_info(movie_info_url):
    ...
    movie_datas = movie_document.xpath('//*[@id="original_header"]/div[2]/section/div[1]/div/span[2]/text()') # 电影上映时间
    movie_tags = movie_document.xpath('//*[@id="original_header"]/div[2]/section/div[1]/div/span[3]/a/text()') # 电影标签
    movie_cost_times = movie_document.xpath('//*[@id="original_header"]/div[2]/section/div[1]/div/span[4]/text()') # 电影时长
...
def main():
    ...
    movie_list = document.xpath('//div[@id="page_1"]/div/div/div[@class="w-full overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm transition-colors hover:border-gray-300"]')
